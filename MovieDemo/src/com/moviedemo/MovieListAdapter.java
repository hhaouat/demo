...
public final class MovieListAdapter extends BaseAdapter {
    ...
    static final String JSON_FILM_CRITICSCORE = "critics_score";
    static final String JSON_FILM_RATINGS = "ratings";
    static final String JSON_CASTING_NAME = "name";
    static final String JSON_LINKS_SIMILAR = "similar";
    private final Context mContext;
    private final ImageLoader mVolleyImageLoader;
    private JSONArray mFilms;

    public MovieListAdapter(Context context, ImageLoader imageLoader) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            title = (TextView) convertView.findViewById(R.id.nameFilm);
